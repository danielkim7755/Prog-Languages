...
\000\000\000\000\024\000\026\000\027\000\025\000\000\000\000\000\
...
\000\000\021\000\000\000\000\000\000\000\000\000\023\000\006\000\
\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\
...
\019\255\000\000\004\255\036\255\004\255\004\255\000\000\000\000\
...
\249\255\036\000\000\000\038\000\030\000\002\000\006\000\243\255"
...
\007\000\008\000\000\000\000\000\007\000\007\000\000\000\000\000\
...
\008\001\024\001\255\255\255\255\012\001\013\001\255\255\255\255\
...
# 312 "nanoParse.ml"
               : Nano.expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'expO) in
    Obj.repr(
# 41 "nanoParse.mly"
           ( _1 )
# 319 "nanoParse.ml"
               : Nano.expr))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 2 : 'expO) in
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expO) in
    Obj.repr(
# 44 "nanoParse.mly"
                  ( Bin(_1,Or,_3) )
# 327 "nanoParse.ml"
...
; (fun __caml_parser_env ->
    ...
    let _3 = (Parsing.peek_val __caml_parser_env 0 : 'expAPP) in
    Obj.repr(
# 64 "nanoParse.mly"
                      ( Bin(_1,Mul,_3) )
# 419 "nanoParse.ml"
...
# 427 "nanoParse.ml"
               : 'expMD))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 0 : 'expAPP) in
    Obj.repr(
# 66 "nanoParse.mly"
             ( _1 )
# 434 "nanoParse.ml"
               : 'expMD))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'expAPP) in
